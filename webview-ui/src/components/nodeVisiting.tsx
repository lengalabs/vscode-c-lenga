...
export function visitNodes(
  ...
  visitor: (
    node: objects.BaseLanguageObject,
  ...
  switch (object.type) {
    case "functionDeclaration": {
      ...
      funcDecl.parameterList.forEach((p, i) =>
        visitNodes(p, visitor, funcDecl, "parameterList", i)
      );
      break;
    }
    ...
    case "callExpression": {
      ...
      callExpr.argumentList.forEach((argument, i) =>
        visitNodes(argument, visitor, callExpr, "argumentList", i)
      );
      break;
    }
