...
export function convertTsLanguageObjectToProto(object: objects.LanguageObject): proto.LanguageObject {
    switch (object.type) {
        case "sourceFile": {
        ...
        case "preprocInclude": {
            let val: proto.LanguageObject = {
                languageObject: {
                    $case: "preprocInclude", preprocInclude: preprocIncludeToProto(object)
                }
            };
            return val;
        }
        ...
        case "reference": {
            const val: proto.LanguageObject = {
                languageObject: {
                    $case: "reference",
                    reference: { id: object.id, identifier: object.identifier, declarationId: object.declarationId }
                }
            };
            return val;
        }
...
export function convertTsDeclarationObjectToProto(object: objects.DeclarationObject): proto.DeclarationObject {
    switch (object.type) {
        case "declaration": {
...
export function convertTsExpressionObjectToProto(object: objects.ExpressionObject): proto.ExpressionObject {
    switch (object.type) {
        case "assignmentExpression": {
...
export function convertTsStatementObjectToProto(object: objects.StatementObject): proto.StatementObject {
...
export function convertTsCompoundStatementObjectToProto(object: objects.CompoundStatementObject): proto.CompoundStatementObject {
...
function assignmentExpressionToProto(assign: objects.AssignmentExpression): proto.AssignmentExpression {
    return {
        id: assign.id,
...
function binaryExpressionToProto(bin: objects.BinaryExpression): proto.BinaryExpression {
    return { id: bin.id, left: convertTsExpressionObjectToProto(bin.left), operator: bin.operator, right: convertTsExpressionObjectToProto(bin.right) };
}
